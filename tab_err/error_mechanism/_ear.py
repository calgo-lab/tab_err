...
class EAR(ErrorMechanism):
    ...
    def _sample(
        ...
        Description:
            ...
            The error free data is then sorted by the value in the conditioning column and the error mask is generated by selecting a contiguous block of sorted entries,
