...
class ENAR(ErrorMechanism):
    """ErrorMechanism subclass implementing the 'Erroneous Not At Random' error mechanism. Errors are assumed to depend on either other variables, the incorrect data itself, or both."""
    ...
    def _sample(
        ...
        Description:
            ...
            The error free data is then sorted by value and the error mask is generated by selecting a contiguous block of sorted entries, thereby having similar values, and marking these entries true in the mask.
            This ensures that occurrance of errors is related to the value of the variable.
        ...
        # ToDo? -- ensure that the implementation is consistent between the ear and enar implementations of _sample -- upper_bound_variable?
